    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card  border-primary mb-3">
                <div class="card-header border-primary text-center">{{ __('Formulario de Registro') }}</div>

                <div class="card-body">
                    <form name="fvalida" method="POST" action="{{ route('register') }}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            <label for="name" class="col-md-4 col-form-label text-md-end">{{ __('Edad') }}</label>
